"""Normalize every source file into clean Markdown under datasets/processed/.
...
Output mirrors the input folders: datasets/raw/fees/x.pdf -> datasets/processed/fees/x.md

ไฟล์ที่มี output ใน datasets/processed/ แล้วจะถูก "ข้าม" (กัน OCR ซ้ำ/จ่าย API ซ้ำ)
...
from data_pipeline.pipeline.clean import clean_thai_text

ROOT = Path(__file__).resolve().parents[2]
load_dotenv(ROOT / ".env")

INPUT_DIR = ROOT / "datasets" / "raw"
